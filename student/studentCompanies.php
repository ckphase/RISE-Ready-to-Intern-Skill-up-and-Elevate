...
<div class="container my-5">
    <h2 class="mb-4">Explore Available Internships</h2>
                    ...
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p><strong>Last Date to Apply:</strong> <?= date("d M Y", strtotime($row['last_date'])) ?></p>
                            </div>
    ...
    <?php else: ?>
        <div class="alert alert-warning text-center">No internships available at the moment.</div>
    <?php endif; ?>
</div>
